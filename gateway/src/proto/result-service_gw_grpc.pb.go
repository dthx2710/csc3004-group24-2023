...
const (
	Result_GetResult_FullMethodName = "/result_service.Result/GetResult"
)
...
func _Result_GetResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ResultServer).GetResult(ctx, in)
	}
...
var Result_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "result_service.Result",
	...
	Metadata: "result-service_gw.proto",
}
